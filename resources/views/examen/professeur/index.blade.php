...
<div class="float-right">
  <a href="{{route('professeure.create')}}"><i class="fa fa-plus"></i> Ajout des Professeures</a>
</div>
<table class="table table-striped">
    <thead>
      <tr>
        <th>Nom professeure</th>
        <th>email</th>
        <th>telephone</th>
        <th>action</th>
      </tr>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          <form action="{{route('professeure.destroy',['professeure'=>$prof])}}" method="POST">
          {{ csrf_field() }}
          {{method_field('DELETE')}}
          
            <a href="{{route('professeure.edit',['professeure'=>$prof])}}" class="btn btn-warning">
  ...
  {{$professeur->links("pagination::bootstrap-5")}}
